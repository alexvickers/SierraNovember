      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-8 col-lg-9">
            ...
            <HomeHeader />
            <p>
              My name is <strong>Alexandre Aimbiré</strong>. I'm <Age /> years
              old and I hail from Florianópolis, a city known for its stunning
              beaches and the legendary tennis player Gustavo Kuerten. These
              days, I’m diving deep into English Language and Literature at the
              University of São Paulo, where I’m rediscovering my passion for
              language. I like to think of myself as a recovering Coca-Cola
              addict — but I still drink coffee by the bucketload.
            </p>
            <p>
              ...
              because, let’s face it, there’s nothing quite like the crackle of
              a record.
            </p>
            <p>
              Take a look at my{" "}
